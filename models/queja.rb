class Queja < ActiveRecord::Base
  ...
  def after_save
    ...
    if ingreso > 0 and self.correspondenciasrecibida_id.to_s == ""
      ...
      if self.tema_vn1.to_s == 'SI' or self.tema_m.to_s == 'SI' or self.tema_msb.to_s == 'SI' or self.tema_t.to_s == 'SI' or self.tema_l.to_s == 'SI' or self.tema_d.to_s == 'SI' or self.tema_po.to_s == 'SI' or self.tema_opv.to_s == 'SI'
        c.dependencia_id = 10003 # Dotacion
      elsif self.tema_vn2.to_s == 'SI' or self.tema_vu.to_s == 'SI' or self.tema_at.to_s == 'SI' or self.tema_cop.to_s == 'SI' or self.tema_pos.to_s == 'SI' or self.tema_des.to_s == 'SI' or self.tema_rea.to_s == 'SI' or self.tema_entr.to_s == 'SI'
        c.dependencia_id = 10042 # Poblacional
      elsif self.tema_e.to_s == 'SI' or self.tema_ava.to_s == 'SI' or self.tema_ch.to_s == 'SI' or self.tema_rs.to_s == 'SI' or self.tema_te.to_s == 'SI'
        c.dependencia_id = 10005 # Juridica
      elsif self.tema_ga.to_s == 'SI' or self.tema_gi.to_s == 'SI' or self.tema_gd.to_s == 'SI' or self.tema_gt.to_s == 'SI' or self.tema_gh.to_s == 'SI'
        c.dependencia_id = 10008 # Administrativa y Financiera
      elsif self.tema_pla.to_s == 'SI'
        c.dependencia_id = 10009 # Planeacion
      end

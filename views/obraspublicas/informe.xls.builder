  ...
  xml.Worksheet 'ss:Name' => 'Informacion Obra Publica' do
    xml.Table do
      xml.Row 'ss:StyleID' => 'header' do
          ...
          xml.Cell { xml.Data 'Estado EDU ', 'ss:Type' => 'String' }
          xml.Cell { xml.Data 'Fecha Estado EDU', 'ss:Type' => 'String' }
      end
      for obraspublica in @obraspublicas
        ...
        xml.Row do
            ...
            xml.Cell { xml.Data obraspublica.estado_edu, 'ss:Type' => 'String' }
            xml.Cell { xml.Data obraspublica.fecha_edu, 'ss:Type' => 'String' }
        end
      end
    end
  end

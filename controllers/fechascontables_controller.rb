  ...
  def create
    ...
    respond_to do |format|
      if @fechascontable.save
        format.html { redirect_to(@fechascontable, :notice => 'Fechascontable was successfully created.') }
  ...
  def update
    ...
    respond_to do |format|
      if @fechascontable.update_attributes(params[:fechascontable])
        format.html { redirect_to(@fechascontable, :notice => 'Fechascontable was successfully updated.') }
        format.xml  { head :ok }
      else
